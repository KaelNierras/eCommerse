<template>
  <div
    class="p-4 h-42 gap-2 flex flex-col backdrop-blur-lg items-center md:h-16 md:justify-between justify-center relative md:flex-row ">

    <div v-if="isLoggedIn" class="flex p-3 flex-row mb-2 items-center">
      <Button variant="ghost" class="font-bold">Men</Button>
      <Button variant="ghost" class="font-bold">Women</Button>
    </div>

    <div class="flex md:pt-0 pt-0 flex-col w-48 items-center md:flex-row gap-2">
      <img src="/yourStyleLogo.jpg" class=" w-36 h-auto pt-4 md:pt-0 hover:cursor-pointer" alt="YourStyle">
    </div>

    <div class="flex md:hidden relative w-56 items-center mt-10">
    ...
    <div class="flex flex-row items-center">
      <Button v-if="!search" variant="ghost" class="hidden md:flex ">
